...
echo "🔗 ArgoCD (GitOps): https://127.0.0.1:8080"
kubectl -n argocd port-forward svc/argocd-server 8080:443 --address 127.0.0.1 >logs/argocd.log 2>&1 &
...
echo "🔗 Argo Rollouts (Canary): http://localhost:3100/rollouts"
